...
class TestStandaloneFileStorage(unittest.TestCase):
    ...
    def test_push_bytes_within_limits(self):
        ...
        """
        data = bytearray(b"A" * 512)  # 512 bytes de datos.
        transaction_id, offset = self.storage.push_bytes(data)
    ...
    def test_push_bytes_exceeding_buffer(self):
        ...
        """
        data = bytearray(b"A" * 2048)  # 2048 bytes (excede buffer de 1024).
        transaction_id, offset = self.storage.push_bytes(data)
    ...
    def test_push_bytes_exceeding_blob_max_size(self):
        ...
        """
        data = bytearray(b"A" * (self.storage.blob_max_size + 1))  # 1 byte más que el tamaño máximo permitido.
    ...
    def test_push_atom(self):
        ...
        # Mock del Atom
        fake_atom = Mock()
        fake_atom.__class__.__name__ = "FakeAtom"
        fake_atom.__dict__ = {"attr1": "value1", "attr2": 123}
    ...
    def test_get_atom(self):
        ...
        fake_data = '{"AtomClass": "FakeAtom", "attr1": "value1", "attr2": 123}'
        self.mock_block_provider.get_reader.return_value = io.BytesIO(fake_data.encode("utf-8"))
